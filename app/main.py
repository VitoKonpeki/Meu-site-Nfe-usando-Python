...
def upload_notas():
    ...
    arquivos = request.files.getlist("arquivo_xml")
    ...
    for arquivo in arquivos:
        ...
        caminho = os.path.join(pasta, os.path.basename(arquivo.filename))
    ...
    mensagem = f"Importação concluída! {contador_sucesso} notas importadas com sucesso."
    if contador_erro > 0:
        mensagem += f" {contador_erro} arquivo(s) com erro."
